...
// ANSWER: Both functions have a space complexity of O(n) from the for loop in RoundTwo and the forEach in the first countLetters, which both loop through the length of the string
